...
public class ListGroceryFragment extends Fragment {
    ...
    private ListGrocery groceryStorage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = view.findViewById(R.id.rvGroceries);
        rv.setLayoutManager(new LinearLayoutManager(view.getContext()));
        rv.setAdapter(new GroceryListAdapter(view.getContext(), ListGrocery.getInstance().getGroceries()));

        System.out.println("ListGroceryFragment.onCreateView() called");
        return view;
    }
    ...
    public void onResume() {
        super.onResume();
        rv.setAdapter(new GroceryListAdapter(getView().getContext(), ListGrocery.getInstance().getGroceries()));
        System.out.println("ListGroceryFragment.onResume() called");
    }
}